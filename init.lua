...
require('lazy').setup({
  ...
  { -- Useful plugin to show you pending keybinds.
    ...
    opts = {
      icons = {
        -- seticon mappings to true if you have a Nerd Font
    ...
    config = function()
      ...
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(event)
          ...
          map('<leader>dk', vim.diagnostic.goto_prev, '[D]iagnostic Prev')
  ...
  { -- Collection of various small independent plugins/modules
    ...
    config = function()
      ...
      -- computes statusline for the active buffer
      ...
      --computes statusline for inactive buffers
